...
public class ChuyenNganhAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.linearLayout=convertView.findViewById(R.id.linearLayoutSuaNganh);
            ...
            holder.ivDelete = convertView.findViewById(R.id.imageViewdeleteCn);
            holder.imageViewhinh = convertView.findViewById(R.id.imageView);
            holder.ivEdit = convertView.findViewById(R.id.imageeditCn);
        ...
        holder.ivEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                chuyenDao = new DaoChuyenNganh(context);
                final AlertDialog.Builder builder = new AlertDialog.Builder(context);
                LayoutInflater inflater = ((Activity) context).getLayoutInflater();
                View view = inflater.inflate(R.layout.edit_nganh, null);
                final EditText etmanganh = view.findViewById(R.id.editMaNganh);
                final EditText ettennganh = view.findViewById(R.id.editTenNganh);
