...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql = " INSERT INTO SINHVIEN VALUES ('20206560','Nguyen lam Khoa','nguyenlamkhoa@gmail.com',NULL,'TiengAnh','KHVL')";
        db.execSQL(sql);
        sql = " INSERT INTO SINHVIEN VALUES ('20206558','Nguyen Thanh Long','nguyentl@gmail.com',NULL,'Laptrinh','KHMT')";
        db.execSQL(sql);
        sql = " INSERT INTO SINHVIEN VALUES ('20206557','La Van Hop','Lavanhop@gmail.com',NULL,'Toan','KHMT')";
        db.execSQL(sql);
        // tao bang diem
